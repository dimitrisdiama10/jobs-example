...
return [
    ...
    */
    ...
    'ascii' => 'Το πεδίο :attribute πρέπει να περιέχει μόνο χαρακτήρες ASCII.',
    ...
    'missing_with' => 'Το πεδίο :attribute πρέπει να λείπει όταν το :values υπάρχει.',
    'missing_with_all' => 'Το πεδίο :attribute πρέπει να λείπει όταν τα :values υπάρχουν.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Το :attribute που δώσατε έχει εμφανιστεί σε διαρροή δεδομένων. Παρακαλώ επιλέξτε διαφορετικό :attribute.',
    ],
    ...
    'present_with' => 'Το πεδίο :attribute πρέπει να υπάρχει όταν το :values υπάρχει.',
    'present_with_all' => 'Το πεδίο :attribute πρέπει να υπάρχει όταν τα :values υπάρχουν.',
    ...
    'prohibited_if_declined' => 'Το πεδίο :attribute απαγορεύεται όταν το :other έχει απορριφθεί.',
    'prohibited_unless' => 'Το πεδίο :attribute απαγορεύεται εκτός αν το :other είναι σε :values.',
    'prohibits' => 'Το πεδίο :attribute απαγορεύει το :other να υπάρχει.',
    ...
    'required_with_all' => 'Το πεδίο :attribute είναι υποχρεωτικό όταν τα :values υπάρχουν.',
